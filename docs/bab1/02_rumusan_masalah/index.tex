...
\begin{enumerate}
    ...
    \item Bagaimana kualitas kebijakan ABAC yang dihasilkan algoritma usulan dibandingkan terhadap algoritma berpopulasi (BOA\label{first:boa}, ACO, UBK) dan \textit{compact} murni (\textit{compact-GA\label{first:compact-ga}/PSO}) pada berbagai tingkat korelasi atribut, dan \textit{trade-off} apa yang muncul antara kualitas kebijakan dan kehematan sumber daya?
