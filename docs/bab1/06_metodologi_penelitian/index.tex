...
Proses penelitian mengikuti enam aktivitas DSRM \parencite{peffers_design_2007} berikut, yang alurnya divisualisasikan pada Gambar \ref{fig:dsrm}:
...
\begin{enumerate}
    ...
    \item \textit{Evaluation} -- Mengukur dan membandingkan hasil demonstrasi terhadap metrik (kualitas kebijakan/\textit{F-score} dan WSC, jejak memori, serta waktu komputasi), disertai uji signifikansi statistik perbandingan antar-algoritma terhadap H1-H4.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{dsrm.png}
