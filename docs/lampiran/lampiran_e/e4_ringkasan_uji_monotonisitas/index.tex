...
\begin{longtable}{
    @{}
    >{\raggedright\arraybackslash}p{4.5cm}          % Tuas
    >{\raggedleft\arraybackslash}p{3.5cm}           % Nilai diuji
    >{\raggedright\arraybackslash}p{5.5cm}          % Efek terhadap CoDA-EDA
    >{\raggedright\arraybackslash}p{5.5cm}          % Kesimpulan
    @{}
}
